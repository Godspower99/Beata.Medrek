...
namespace Beata.Medrek
{
    ...
    public class AnimateSlideInFromLeftProperty : AnimateBaseProperty<AnimateSlideInFromLeftProperty>
    {
        protected override async void DoAnimation(FrameworkElement element, bool value, bool firstLoad)
        {
            if (value)
                // Animate in
                await element.SlideAndFadeInAsync(AnimationSlideInDirection.Left, firstLoad, firstLoad ? .3f : 0.3f, keepMargin: false);
            else
                // Animate out
    ...
    public class AnimateSlideInFromRightProperty : AnimateBaseProperty<AnimateSlideInFromRightProperty>
    {
        protected override async void DoAnimation(FrameworkElement element, bool value, bool firstLoad)
        {
            if (value)
                // Animate in
                await element.SlideAndFadeInAsync(AnimationSlideInDirection.Right, firstLoad, firstLoad ? 5 : 0.3f, keepMargin: false);
            else
                // Animate out
    ...
    /// NOTE: Keeps the margin
    /// </summary>
    public class AnimateSlideInFromBottomRemoveMargiVisibleProperty : AnimateBaseProperty<AnimateSlideInFromBottomMarginProperty>
    {
        protected override async void DoAnimation(FrameworkElement element, bool value, bool firstLoad)
        {
            if (value)
    ...
    /// </summary>
    public class AnimateFadeInPropertyOneThird : AnimateBaseProperty<AnimateFadeInPropertyOneThird>
    {
        protected override async void DoAnimation(FrameworkElement element, bool value, bool firstLoad)
        {
            if (value)
                // Animate in
                await element.FadeInOneThirdAsync(firstLoad, firstLoad ? 0 : 0.3f);
            else
                // Animate out
                await element.FadeOutOneThirdAsync(firstLoad ? 0 : 0.3f);
        }
    }
