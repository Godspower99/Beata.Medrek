...
namespace Beata.Medrek
{
    ...
    public static class StoryboardHelpers
    {
        ...
        #region Fade In/Out 0.3 Opacity
        /// <summary>
        /// Adds a fade in animation to the storyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation to</param>
        /// <param name="seconds">The time the animation will take</param>
        public static void AddFadeInOneThird(this Storyboard storyboard, float seconds, bool from = false)
        {
            // Create the margin animate from right 
            var animation = new DoubleAnimation
            {
        ...
        /// <param name="storyboard">The storyboard to add the animation to</param>
        /// <param name="seconds">The time the animation will take</param>
        public static void AddFadeOutOneThird(this Storyboard storyboard, float seconds)
        {
            // Create the margin animate from right 
            var animation = new DoubleAnimation
            {
